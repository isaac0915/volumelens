...
- `frontend/app/page.js` — Overview dashboard: product intro hero with coverage stats, index cards (`/api/market`), watchlist with change % (`/api/stocks`, 3s), and 收盤爆量排行 (`/api/daily-spikes`); shows 盤中 vs 已收盤 from `market_open`
